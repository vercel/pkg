  ...
  if (newTuple) {
    ...
    if (name) {
      try {
        ...
        if (d) {
          // if there is dict - set it as pkgConfig
          // even if there is already pkgConfig
          // TODO wrap dicts into `pkgConfig` and apply them to package.json
          newTuple.config.pkgConfig = d;
