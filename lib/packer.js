    ...
    for (const store of [ STORE_BLOB, STORE_CONTENT, STORE_LINKS, STORE_STAT ]) {
      ...
      if (store === STORE_STAT) {
        if (typeof value === 'object') {
          ...
          if (value.blksize !== undefined) value.blksize = 4096;
          if (value.blocks !== undefined) value.blocks = 0;
          if (value.dev !== undefined) value.dev = 0;
          if (value.gid !== undefined) value.gid = 20;
          if (value.ino !== undefined) value.ino = 0;
          if (value.nlink !== undefined) value.nlink = 0;
          if (value.rdev !== undefined) value.rdev = 0;
          if (value.uid !== undefined) value.uid = 500;
          // portable
